...
package com.permeance.utility.scriptinghelper.portlets;
...
public class ScriptingHelperPortlet extends MVCPortlet {
    ...
    public void doView(RenderRequest renderRequest, RenderResponse renderResponse) throws IOException, PortletException {
        try {
            ...
            include("/html/portlet/scripting-helper/view.jsp", renderRequest, renderResponse);
        } catch (Exception e) {
            _log.warn(e);
            include("/html/portlet/scripting-helper/error.jsp", renderRequest, renderResponse);
        }
    }
